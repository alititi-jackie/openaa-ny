    ...
    <div className="min-h-screen bg-zinc-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <ChannelSeoSection
          title="纽约租房与华人房屋信息指南"
          paragraphs={[
            'OpenAA 房屋频道围绕纽约租房和本地居住需求整理信息，覆盖法拉盛租房、皇后区租房、华人房屋出租、求租求购等高频场景。很多用户在�[...]
            '这个频道适合准备换房的上班族、刚落地纽约的新移民、需要短租过渡的学生以及帮家人找房的用户。你可以在“房源信息”和“求租求��[...]
            'OpenAA 提供的帮助不只是发布入口，还包括更接近日常决策的浏览方式：同类信息集中展示，价格、区域、发布时间一屏可对比。真实使用�[...]
          ]}
